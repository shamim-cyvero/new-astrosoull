                ...
                <Stack w={'100%'} alignItems={'center'} justifyContent={'center'} direction={{base:'column',md:'column',lg:'row'}}>
                    ...
                    <VStack  w={{base:'100%',md:'100%',lg:'50%'}}  spacing={3}>
                        ...
                        <form style={{ width: '90%' ,marginTop:'10px'}} onSubmit={formSubmit}>
                            ...
                            <VStack w={'100%'}>
                                <Button colorScheme='whatsapp' type='submit' size={['sm','md']} w={'100%'} mt={'20px'} p={'2px 0px'} fontSize={'1.2rem'}>Login</Button>
                            </VStack>
                            ...
                            <HStack m={'1vmax 0'} w={'100%'} justifyContent={'center'} alignItems={'center'}>
                                <Button isLoading={loading} onClick={()=>navigate('/astrologerlogin')} alignSelf={'center'} children={'Astrologer Login'} size={['sm','md']}   p={'2px 0px'} fontSize={'1.2rem'} _hover={{ bg: "#1f3b64", cursor: "pointer",color:'white' }}  />
                            </HStack>
                        </form>
                    </VStack>
                </Stack>
